...
public class FConstants30630 {
    static {
        ...
        FollowerConstants.xMovement = 66.0237; // 61.043622825611145 at 255 2/17
        FollowerConstants.yMovement = 48.1231; // 42.621403162065704 at 255 2/17 43.6631

        FollowerConstants.forwardZeroPowerAcceleration = -36.6065; // -27.941003214676822 at 255 2/17
        FollowerConstants.lateralZeroPowerAcceleration = -51.0128; // -82.32803462012504 at 255 2/17

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.05,0.0001,0.01,0); // 0.2,0.0001,0.01,0 at 255 2/17
        ...
        FollowerConstants.headingPIDFCoefficients.setCoefficients(1,0,0.04,0); // 2,0,0.1,0 at 255 2/17
